...
\author{\normalsize\centering Gildas TAGNY NGOMPÉ}
...
%
%\include{contents/contrib-structuration}
%\include{contents/contrib-demandes}
\include{contents/contrib-sensresultat}
%\include{contents/contrib-similarite}
%
