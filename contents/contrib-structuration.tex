...
\begin{frame}{Sectionner pour organiser l'extraction des connaissances}
\scriptsize
\begin{columns}
...
\subsection{Représentation et sélection de modèle}
\begin{frame}{Représentation et sélection de modèle : objectif}
		\begin{figure}
			\includegraphics[width=0.6\textwidth]{structuration-training.png}
		\end{figure}
...
\begin{frame}{Description manuelle vs. représentation apprise} \scriptsize
